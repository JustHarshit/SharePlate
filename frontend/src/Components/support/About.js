    ...
    <div className="about-container">
      ...
      <div className="about-content">
        <div className="about-text">
          <h3>Our Vision</h3>
          <p>
            We envision a world where surplus food is never wasted, and hunger is a thing of the past. By fostering a community-driven approach, <strong>SharePlate</strong> aims to be a catalyst for change, enabling individuals and organizations to contribute to a more sustainable and equitable future.
          </p>
        </div>
      </div>
      ...
      <div className="about-content">
        <div className="about-text">
          ...
          <p>
            Whether you're a donor, an NGO, or a volunteer, you can make a difference by being part of <strong>SharePlate</strong>. Help us create a sustainable future where food is shared and wasted food is no longer a burden.
          </p>
        </div>
      </div>
