...
const Learn = () => {
  ...
  return (
    <div className="learn-container">
      <h1 className="learn-heading">Learn More About SharePlate</h1>
      
      {/* Section 1 */}
      <section className="learn-section">
        <h2>What is SharePlate?</h2>
        <p>
          SharePlate is a platform dedicated to reducing food waste by connecting event organizers,
          restaurants, and hotels with NGOs and volunteers to redistribute surplus food to communities
          in need. By building a network of donors and receivers, SharePlate plays a crucial role in
      ...
      <section className="learn-section">
        ...
        <ol>
          <li><strong>Step 1: Food Donation</strong> - Donors list available surplus food on SharePlate.</li>
          <li><strong>Step 2: Matchmaking</strong> - SharePlate’s system matches donations with registered NGOs and communities in need.</li>
      ...
      <section className="learn-section call-to-action">
        ...
        <p>
          If you're passionate about sustainability, community impact, and reducing food waste, SharePlate
